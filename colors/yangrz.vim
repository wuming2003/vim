...
hi Type						   ctermfg=LightGreen guifg=#80a0ff	gui=none
...
hi StatusLine	term=reverse   cterm=reverse  	  gui=NONE      guibg=#333333	guifg=White
hi StatusLineNC term=reverse   cterm=reverse	  gui=NONE		guifg=white guibg=#333332
